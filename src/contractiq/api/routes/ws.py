...
from contractiq.api.dependencies import get_settings
from contractiq.api.ws_manager import ws_manager
from contractiq.db.connection import AsyncSessionFactory, _create_async_engine
...
async def websocket_notifications_endpoint(websocket: WebSocket):
    ...
    try:
        await ws_manager.send_personal_message(
            {"event": "connected", "message": "Subscribed to ContractIQ push notifications"},
            client_id,
        )
        while True:
