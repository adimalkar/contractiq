...
class Settings(BaseSettings):
    """ContractIQ centralized application settings."""
    ...
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://aditya@localhost:5432/contractiq",
        description="Async SQLAlchemy database connection string",
    )
    DATABASE_URL_SYNC: str = Field(
        default="postgresql://aditya@localhost:5432/contractiq",
    ...
    API_KEY: str = Field(
        default="contractiq-secret-key-prod",
