...
from contractiq.db.models import Document
...
from contractiq.pipeline.processor import DocumentProcessor
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="ContractIQ Document Ingestion Pipeline")
